                ...
                <div className="h-full flex flex-col justify-start">
                    ...
                    <div className="flex h-1/2 lg:justify-end lg:mr-40 md:justify-center sm:justify-center">
                        <div className="flex flex-col">
                            ...
                            <Link to="/shop" className="text-center lg:text-2xl md:text-xl sm:text-lg lg:pt-3 md:pt-22 sm:pt-1 bg-amber-50 secondaryFont h-1/5 rounded hover:bg-transparent border-2 border-white-500 text-yellow-500">
                                    SHOP
                            </Link>
