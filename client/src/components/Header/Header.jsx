                ...
                <div className="h-full flex flex-col justify-start">
                    ...
                    <div className="flex h-1/2 lg:justify-end lg:mr-40 md:justify-center sm:justify-center">
                        <div className="flex flex-col">
                            ...
                            <Link to="/shop" className="flex justify-center align-center items-center lg:text-2xl md:text-xl sm:text-lg bg-amber-50 secondaryFont lg:h-1/5 md:1/4 rounded hover:bg-transparent border-2 border-white-500 text-yellow-500">
                                    SHOP
                            </Link>
